...
From the **repository root**: `./harness-sre.sh`, `./harness-db.sh`, `./harness-k8s.sh`, `./harness-redis.sh`, `./harness-kafka.sh`, `./harness-elk.sh`. Commands by role: [HowToUse.md](../HowToUse.md). Full run book: [root README — How to launch](../README.md#how-to-launch-from-the-repository-root).
