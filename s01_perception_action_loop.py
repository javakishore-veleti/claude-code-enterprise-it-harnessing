...
pattern where the LLM is prompted, evaluates if it needs to use a tool (specifically  the 'bash' tool in this session), executes that tool, and continues until a 
