...
Perception means organizing, identifying, and interpreting sensory information
to understand the environment. Sensory information (sight, sound, touch, taste,
and smell) becomes meaningful awareness. In this agent, those senses are the
user's query and tool results; the model organizes them into an understanding
of the environment, then acts (bash) and observes again.

This script is the entry point for the agent series. It demonstrates the
foundational perception-action cycle: the LLM is prompted, evaluates whether
it needs a tool (bash in this session), executes it, and continues until a
...
from core import (
    ...
    MODEL,            # The specific model ID (e.g. Claude Sonnet 5)
